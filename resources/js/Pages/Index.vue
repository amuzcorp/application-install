<template>
    <InstallLayout>
        <!-- Hero section -->
        <div class="relative isolate max-h-screen overflow-hidden">
            ...
            <div class="mx-auto max-w-7xl px-6 py-12 sm:py-16 lg:flex lg:gap-x-10 lg:px-8 lg:py-32">
                <div class="mx-auto max-w-2xl lg:mx-0 lg:flex-auto pt-8 sm:pt-16 lg:pt-20">
                    ...
                    <div class="mt-10 flex items-center gap-x-6">
                        <a :href="route('application-install.ios')" class="flex items-center rounded-md bg-rose-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-rose-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-rose-600">
                        ...
                        <a :href="route('application-install.android')" class="flex items-center rounded-md bg-rose-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-rose-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-rose-600">
                            <div class="text-white w-6 h-6">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 50 50">
                        ...
                        <a :href="route('application-install.releases')" class="text-sm font-semibold leading-6 text-gray-900">
        ...
        <!-- Feature section -->
        <div id="#features" class="mx-auto max-w-7xl px-6 lg:px-8 bg-gray-50 py-16 md:py-24 lg:py-32">
            <div class="mx-auto max-w-2xl lg:text-center">
                <h2 class="text-base font-semibold leading-7 text-rose-600">
                    {{ __('Features') }}
                </h2>
            ...
            <div class="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-4xl">
                <dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
                    <div v-for="feature in $page.props.frontConfig['features']" :key="feature.name" class="relative pl-16">
                        ...
                        <dd class="mt-2 text-base leading-7 text-gray-600">{{ __(feature.description) }}</dd>
                    </div>
                </dl>
            </div>
        </div>
